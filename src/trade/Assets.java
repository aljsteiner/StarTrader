...
//  static int sgIx = -1;
  ...
  /**
   * get the sum of ship costs to travel 1 year
   * force the calculation of the value if not currently set
   * called in Econ
  ...
  /**
   * get the initial trade bid (goods) with the needs 
   * force the calculation of the value if not currently set
   * called in Econ
  ...
  /**
   * get the trade strategic vars, high values greatest needs
   * force the calculation of the value if not currently set
   * called in Econ
